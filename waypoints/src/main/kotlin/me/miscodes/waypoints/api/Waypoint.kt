...
interface Waypoint : GUIDisplayable, Deletable {
  ...
  suspend fun copyOptionalFieldsFrom(other: Waypoint)

  /**
   * Deletes this waypoint from the database.
   *
   * First a [me.miscodes.waypoints.api.event.WaypointPreDeleteEvent] is triggered, in case you
   * still need the waypoint. After that the
   * [me.miscodes.waypoints.api.event.WaypointPostDeleteEvent] is triggered with the waypoint
