...
interface Folder : GUIFolder, Deletable {
   ...
   *
   * First a [me.miscodes.waypoints.api.event.FolderPreDeleteEvent] is triggered, in case you still
   * need the folder. After that the [me.miscodes.waypoints.api.event.FolderPostDeleteEvent] is
