...
class Translations(tl: TranslationLoader) {
  ...
  val TEXT_DURATION_ADD_SPACES = BooleanTranslationOption(tl, "text.duration.addSpaces")
  ...
  val OVERVIEW_CYCLE_SORT_INACTIVE_COLOR =
      Translation(
          tl,
          "inventory.overview.cycleSort.inactiveColor",
  ...
  val OVERVIEW_DESELECT_NAMES_WAYPOINT_DEATH =
      Translation(
          tl,
          "inventory.overview.deselect.names.waypoint.death",
          miniMessage = tl.itemMiniMessage,
      )
  val OVERVIEW_DESELECT_NAMES_WAYPOINT_PUBLIC =
      Translation(
          tl,
          "inventory.overview.deselect.names.waypoint.public",
          miniMessage = tl.itemMiniMessage,
      )
  ...
  val OVERVIEW_DESELECT_NAMES_PLAYER_TRACKING =
      Translation(
          tl,
          "inventory.overview.deselect.names.playerTracking",
          miniMessage = tl.itemMiniMessage,
      )
